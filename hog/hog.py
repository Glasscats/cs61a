...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    if player_score < opponent_score and opponent_score - player_score > 0 and  opponent_score - player_score < 3:
        return True
    return False
    # END PROBLEM 4b
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    while num_of_dice > 0:
        current_roll = make_averaged(roll_dice, trials_count)(num_of_dice, dice)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    result = extra_turn(score + total, opponent_score)
    if bacon_strategy(score, opponent_score, cutoff, num_rolls) == 0 or result:
        return 0
    return num_rolls
    # END PROBLEM 11
